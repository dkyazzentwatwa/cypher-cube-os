...
- Compact campaign state saves to `/waveshare-os/cardputer-game-os/states/guildmaster_pocket.txt`.
- Journal entries append to `/waveshare-os/cardputer-game-os/saves/guildmaster_pocket.txt`.
