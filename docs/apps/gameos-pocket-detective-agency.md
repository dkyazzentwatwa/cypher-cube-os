...
- Compact campaign state saves to `/waveshare-os/cardputer-game-os/states/pocket_detective_agency.txt`.
- Journal entries append to `/waveshare-os/cardputer-game-os/saves/pocket_detective_agency.txt`.
