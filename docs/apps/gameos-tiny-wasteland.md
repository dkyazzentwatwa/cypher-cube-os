...
- Compact campaign state saves to `/waveshare-os/cardputer-game-os/states/tiny_wasteland.txt`.
- Journal entries append to `/waveshare-os/cardputer-game-os/saves/tiny_wasteland.txt`.
