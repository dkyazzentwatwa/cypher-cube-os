...
- Compact campaign state saves to `/waveshare-os/cardputer-game-os/states/pocket_kingdom_manager.txt`.
- Journal entries append to `/waveshare-os/cardputer-game-os/saves/pocket_kingdom_manager.txt`.
