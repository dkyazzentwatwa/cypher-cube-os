...
- Compact campaign state saves to `/waveshare-os/cardputer-game-os/states/cyber_ranger.txt`.
- Journal entries append to `/waveshare-os/cardputer-game-os/saves/cyber_ranger.txt`.
