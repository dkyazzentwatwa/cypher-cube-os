...
- Compact campaign state saves to `/waveshare-os/cardputer-game-os/states/signal_rat_cyberdeck_rpg.txt`.
- Journal entries append to `/waveshare-os/cardputer-game-os/saves/signal_rat_cyberdeck_rpg.txt`.
