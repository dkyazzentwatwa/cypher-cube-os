...
- Compact campaign state saves to `/waveshare-os/cardputer-game-os/states/star_trail_rancher.txt`.
- Journal entries append to `/waveshare-os/cardputer-game-os/saves/star_trail_rancher.txt`.
